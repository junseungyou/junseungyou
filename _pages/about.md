...
Publications
------
- **BASTAG: Byte-level Access Control on Shared Memory using ARM Memory Tagging Extension (to appear)**
  <span style="font-size: 14px;">_**Junseung You**_, Jiwon Seo, Kyeongryong Lee, Yeongpil Cho, and Yunheung Paek</span>
  <span style="font-size: 14px;">ACM Conference on Computer and Communications Security (**CCS**) 2025</span>
